...
import com.base.App;
import com.base.activity.RegisterActivity;
...
public class UIUtils {
    ...
    public  static  void showSelect(Context context,String title, String[] datas, DialogInterface.OnClickListener listener){
        AlertDialog.Builder builder = new AlertDialog.Builder(context, android.R.style.Theme_Holo_Light_Dialog);
        //builder.setIcon(R.drawable.ic_launcher);
        builder.setTitle(title);
        //    指定下拉列表的显示数据
        final String[] cs = datas;
