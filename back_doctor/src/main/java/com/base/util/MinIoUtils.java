...
public class MinIoUtils {
    ...
    public static final String chunkBucKet = "car";
    ...
    /**
     * @param
     * @return java.com.base.util.List<java.lang.String>
    ...
    /**
     * @return java.com.base.util.List<io.minio.messages.Bucket>
     * @Description 列出所有存储桶
     */
    @SneakyThrows
    ...
    public MinIoUploadResDTO upload(MultipartFile multipartFile, String bucketName, String directory) throws Exception {
        ...
        return new MinIoUploadResDTO(minFileName, getObjectUrl(bucketName, minFileName));
    }
