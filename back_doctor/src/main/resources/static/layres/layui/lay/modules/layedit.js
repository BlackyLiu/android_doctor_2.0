        ...
        var n = t.document, o = e(n.body), c = {
            link: function (i) {
                ...
                x.call(this, function (i) {
                    v.call(t, "img", {src: i.src, alt: i.alt,style:"display:inline-block;width:95%;height:auto;"}, e)
                })
            }, image: function (a) {
                var n = this;
                layui.use("upload", function (o) {
                    ...
                    o.render({
                        url: r.url, method: r.type, elem: e(n).find("input")[0], done: function (e) {
                            200 == e.code ? (e.data = e.data || {},i.msg("上传成功"), v.call(t, "img", {
                                src: e.data.imgPath,
//                                alt: e.data.title,
                                style:"display:inline-block;max-width:95%;height:auto"
                            }, a)) : i.msg(e.msg || "上传失败")
                        }
                    })
                })
                ...
                layui.use("upload", function(o) {
                    ...
                    o.render({
                        ...
                        before:r.before,
                            ...
                            200 == e.code ? (e.data = e.data || {},i.msg("上传成功"), v.call(t, "video", {
                                src: e.data.videoPath,
//                                alt: e.data.title,
                                style:"display:inline-block;max-width:10%;height:auto",
                                controls:"controls"
                            }, a)) : i.msg(e.msg || "上传失败")
                        }
                    })
