...
//	$.ajax({
//        cache: true,
//        url: '/front/assets/waifu-tips.json',
//        dataType: "json",
...
//if(fwCount&&fwCount==1){
//    showMessage("欢迎光临", 3000, true);
//    // $(audio).after("<div class='tempEle'></div>")
//    // $(".tempEle").click(()=>{
//    audio.src = "/front/sound/hygl.mp3"
//    audio.oncanplay = ()=>{
//        audio.play()
//    }
//}
...
$("#live2d").click(()=>{
    if(clickNum < 3){
        audio.src = "/front/sound/x.mp3"
        showMessage("好痒呀.... ", 3000, true);
        audio.play()
        clickNum++
    }else{
        audio.src = "/front/sound/ty.mp3"
        showMessage("讨厌 ", 3000, true);
        audio.play()
        clickNum++
    }
})
