    		    ...
    		    tableIns = table.render({
    		         ...
    		         cols : [[
    		             {type: "checkbox", fixed:"left"},
                          {field: 'medicalTreatmentNo', title: 'medicalTreatmentNo', align:"center"},
                          {field: 'email', title: 'email', align:"center"},
                          {field: 'password', title: 'password', align:"center"},
                          {field: 'realName', title: 'realName', align:"center"},
                          // {field: 'price', title: '金额', align:"center"},
                          {field: 'contactInformation', title: 'contactInformation', align:"center"},
                            {field: 'birthday', title: 'birthday', align:"center",templet:function(d){
			    		            	 return util.toDateString(new Date(d.birthday).getTime(), "yyyy-MM-dd HH:mm:ss");
			    		   }},
    		             ...
    		             {title: 'operate', templet:'#patientListBar',width:200,fixed:"right",align:"center"}
    		         ]]
    		     });
    		     if(isRenderPage){
    			     laypage.render({
...
//            layer.msg("请输入搜索的内容,暂支持用户名的模糊搜索");
    ...
    //添加用户
    function addPatient(edit){
        var index = layui.layer.open({
            title : "Add users",
            type : 2,
            content : "/jump/toPatientAdd",
            end:function(){
              	 queryData(page,size,searchObj,true);
               },
...
//                console.log(edit);
               ...
               body.find("#medicalTreatmentNo").val(edit.medicalTreatmentNo);
               ...
               body.find("#birthday").val(util.toDateString(new Date(edit.birthday).getTime(), "yyyy-MM-dd HH:mm:ss"));
    ...
    $(".delAll_btn").click(function(){
        var checkStatus = table.checkStatus('patientList'),
